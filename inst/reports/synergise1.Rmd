...
```{r synergise.filtering.ppmErrorQsPre, echo=FALSE, result="asis"}
```
...
```{r synergise.filtering.ppmErrorQsPost, echo=FALSE, result="asis"}
```
...
```{r synergise.rtmodel.rtdiffsTable, echo=FALSE, result="asis"}
```
...
```{r synergise.grid.bestParamaters, echo=FALSE, result="asis"}
```
...
```{r synergise.emrt.table, echo=FALSE, result="asis"}
```

## Performance

```{r synergise.performance, echo=FALSE, result="asis"}
```
