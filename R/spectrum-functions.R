...
.spectrumXml2spectra <- function(df, file, prefix, assaydata, storeAll=TRUE,
                                 fileId=0, verbose=TRUE) {
  ...
  sequence_keys <- paste("peptide.seq", prefix, df$precursor.leID,
                         sep=":")
...
.createMsnbaseSpectrum2 <- function(leID, precursor.mhp, precursor.inten,
  ...
  new("Spectrum2",
      ...
      acquisitionNum=as.integer(leID),
