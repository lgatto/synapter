.Synapter <- setRefClass("Synapter",
                         fields = list(
                           ...
                           ## mfMSePeptideData = "data.frame", ## mf for matching filtered - removed in 0.7.0
                           ...
                           ## mfHDMSePeptideData = "data.frame", ## mf for matching filtered - removed in 0.7.0 
