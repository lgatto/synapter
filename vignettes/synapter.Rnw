...
<<falsepostab, echo=FALSE,results=tex>>=
print(xtable(round(res[signms[-i], ], 3),
             caption = "False positives at a FDR of 0.10.",
             table.placement = "thb",
             label = "tab:fp"),
      size = "scriptsize")
@ 

<<upstab, echo=FALSE,results=tex>>=
...
A total \Sexpr{n1} proteins show a statistically different pattern between the two groups, at a false discovery rate of 10\%, 
of which \Sexpr{n2} are not UPS1 proteins (table \ref{tab:fp}).
